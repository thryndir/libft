...
LIB_SRCS = ft_strlen.c ft_isprint.c ft_isalnum.c\
ft_isalpha.c ft_isdigit.c ft_memset.c ft_isascii.c ft_bzero.c\
...
BONUS = ft_lstsize.c ft_lstlast.c ft_lstnew.c\
